...
class Reviewable < ActiveRecord::Base
  ...
  def log_history(reviewable_history_type, performed_by)
  ...
  def update_fields(params, performed_by)
    ...
    self.category_id = params[:category_id] if params[:category_id]

    result = false

    Reviewable.transaction do
      result = save
      log_history(:edited, performed_by) if result
    end
